...
export default function AboutSection({ page }: Props) {
  ...
  return (
    <section className="px-5 pt-[5rem] min-h-[calc(100vh-3.5rem)] flex flex-wrap w-full relative">
      <div className='flex items-end lg:absolute lg:bottom-5 w-full lg:w-auto opacity-75 lg:right-5'>
        {page.heroImage && (
          <SanityImage
      ...
      <div className='text-2xl lg:text-4xl lg:h-full w-full lg:w-3/5 content-center leading-[3rem] lg:ml-5 pt-10 lg:pt-20'>
